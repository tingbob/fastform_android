...
public class FormElementTextQrcodeScanViewHolder extends BaseViewHolder {
    ...
    public OnQrcodeScanButtonClickListener onQrcodeScanButtonClickListener;

    public FormElementTextQrcodeScanViewHolder(View v, OnQrcodeScanButtonClickListener onQrcodeScanButtonClickListener) {
        super(v);
        mTextViewRequired = v.findViewById(R.id.formElementRequired);
        mTextViewTitle = v.findViewById(R.id.formElementTitle);
        mTextViewValue = v.findViewById(R.id.formElementValue);
        mImageButton = v.findViewById(R.id.formElementButton);
    ...
    public void bind(int position, FormElementObject formElement, final Context context) {
        ...
        mImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onQrcodeScanButtonClickListener != null) {
                    onQrcodeScanButtonClickListener.onQrcodeScanButtonClick(formElement.getTag());
                }
            }
        });
    }
